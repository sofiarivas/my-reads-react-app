...
class ListBooks extends Component {
  	...
  	filterByShelf = (books) => {
      const currentShelf = 'read'
      const match = new RegExp(escapeRegExp(currentShelf))
      let filteredBooks = books.filter((book) => match.test(book.shelf))
      return filteredBooks
    }
  
	render() {
      const testBooks = this.filterByShelf(this.props.books)
      console.log(testBooks)
      return (
        <div className="list-books">
        	<Book details={{title: 'hola', author: 'sofi', image: "http://books.google.com/books/content?id=PGR2AwAAQBAJ&printsec=frontcover&img=1&zoom=1&imgtk=AFLRE73-GnPVEyb7MOCxDzOYF1PTQRuf6nCss9LMNOSWBpxBrz8Pm2_mFtWMMg_Y1dx92HT7cUoQBeSWjs3oEztBVhUeDFQX6-tWlWz1-feexS0mlJPjotcwFqAg6hBYDXuK_bkyHD-y&source=gbs_api"}}/>
